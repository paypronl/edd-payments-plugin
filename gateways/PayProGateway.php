...
abstract class PayProGateway {
	...
	public function isAvailable() {
		...
		return $currency === 'EUR' && $edd_options['edd_paypro_gateway_api_key'];
	}
	...
	public function processPayment($purchaseData) {
		...
		edd_set_error( 'edd_paypro_gateway_error', __('There was an issue processing your payment.', 'edd-paypro-gateway'));
	...
	public function confirmPage($content) {
		...
		if (isset($_GET['payment-id'])) {
			$payment = PayProHelper::processPayment(intval($_GET['payment-id']));
